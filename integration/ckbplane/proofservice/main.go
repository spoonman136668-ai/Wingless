...
func (proofEngine) Run(ctx context.Context, req ckbplane.TransportRequest) (ckbplane.CandidateEnvelope, error) {
...
func main() {
	...
	if err := ckbplane.ServeLoopbackService(context.Background(), session, proofEngine{}, os.Stdout); err != nil {
